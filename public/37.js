...
/***/ "./resources/js/isomophic/admin/components/IncidentSeverity/index.js":
/*!***************************************************************************!*\
  !*** ./resources/js/isomophic/admin/components/IncidentSeverity/index.js ***!
  \***************************************************************************/
...
var ModalFormAccount = /*#__PURE__*/function (_Component) {
  ...
  function ModalFormAccount(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "checkNumberCode", function (rule, value, callback) {
      var isNumber = /[0-9]/;
      var isExit = false;
      var minMax = false;
      ...
      return isExit ? minMax ? callback('in the range of 0 to 127') : callback() : value.length === 0 ? callback() : callback('Wrong number entered');
    });
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Modal, {
        ...
        rules: [{
          ...
          validator: this.checkNumberCode // message:"Code in the range of 0 to 127"
...
/***/ "./resources/js/isomophic/admin/containers/IncidentSeverity/index.js":
/*!***************************************************************************!*\
  !*** ./resources/js/isomophic/admin/containers/IncidentSeverity/index.js ***!
  \***************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _components_IncidentSeverity__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../components/IncidentSeverity */ "./resources/js/isomophic/admin/components/IncidentSeverity/index.js");
/* harmony import */ var _redux_IncidentSeverity_actions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../redux/IncidentSeverity/actions */ "./resources/js/isomophic/admin/redux/IncidentSeverity/actions.js");
...
var Users = /*#__PURE__*/function (_BaseComponent) {
  ...
  _createClass(Users, [{
    ...
    value: function componentDidMount() {
      ...
      Object(_helpers_message__WEBPACK_IMPORTED_MODULE_15__["listenSocket"])(this.socketIO, _helpers_flags__WEBPACK_IMPORTED_MODULE_16__["default"].INCIDENT_SEVERITY, function (flag, data) {
        var newPage = {
    ...
    value: function render() {
      ...
      columns = [{
        ...
        render: function render(text, row) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, row.code);
        }
      }, {
      ...
      }), row ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_IncidentSeverity__WEBPACK_IMPORTED_MODULE_9__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(function (state) {
  return _objectSpread({}, state.IncidentSeverityReducer, {}, state.SocketReducer);
}, _objectSpread({}, _redux_IncidentSeverity_actions__WEBPACK_IMPORTED_MODULE_10__["default"], {}, _redux_Socket_actions__WEBPACK_IMPORTED_MODULE_14__["default"]))(Users));
