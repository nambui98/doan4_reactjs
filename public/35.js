...
/***/ "./resources/js/isomophic/admin/components/Customer/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/isomophic/admin/components/Customer/index.js ***!
  \*******************************************************************/
  ...
  _createClass(ModalFormAccount, [{
    ...
    value: function render() {
        ...
        _this2.props.form.validateFieldsAndScroll(function (err, values) {
          if (!err) {
            if (modalType === 'editStatus') {
              ...
              row.address = values.address; // row.type = values.type;
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Modal, {
        ...
        initialValue: row && row.name ? row.name : null,
        rules: [{
          required: true,
          message: 'Bắt buộc'
        }, {
        ...
        initialValue: row && row.address ? row.address : null,
        rules: [{
          required: true,
          message: 'Bắt buộc'
        }, {
        ...
        label: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "S\u1ED1 \u0111i\u1EC7n tho\u1EA1i"),
        hasFeedback: true,
        style: {
          marginBottom: 10 + 'px'
        }
...
/***/ "./resources/js/isomophic/admin/containers/Customer/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/isomophic/admin/containers/Customer/index.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _components_Customer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../components/Customer */ "./resources/js/isomophic/admin/components/Customer/index.js");
/* harmony import */ var _redux_Customer_actions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../redux/Customer/actions */ "./resources/js/isomophic/admin/redux/Customer/actions.js");
  ...
  _createClass(Accounts, [{
    ...
    value: function render() {
               ...
               */
      {
        ...
        width: 100,
        render: function render(text, row) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_common_control_style__WEBPACK_IMPORTED_MODULE_4__["ActionWrapper"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_uielements_tooltip__WEBPACK_IMPORTED_MODULE_11__["default"], {
            title: "Edit"
      ...
      }), row ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Customer__WEBPACK_IMPORTED_MODULE_9__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(function (state) {
  return _objectSpread({}, state.CustomerReducer);
}, _objectSpread({}, _redux_Customer_actions__WEBPACK_IMPORTED_MODULE_10__["default"]))(Accounts));
