...
/***/ "./resources/js/isomophic/admin/containers/CartWait/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/isomophic/admin/containers/CartWait/index.js ***!
  \*******************************************************************/
...
/* harmony import */ var _redux_CartWait_actions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../redux/CartWait/actions */ "./resources/js/isomophic/admin/redux/CartWait/actions.js");
...
/* harmony import */ var react_dom_test_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! react-dom/test-utils */ "./node_modules/react-dom/test-utils.js");
/* harmony import */ var react_dom_test_utils__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(react_dom_test_utils__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var react_to_print__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! react-to-print */ "./node_modules/react-to-print/lib/index.js");
/* harmony import */ var react_to_print__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(react_to_print__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _print__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./print */ "./resources/js/isomophic/admin/containers/CartWait/print.js");
...
var IncidentDamages = /*#__PURE__*/function (_BaseComponent) {
  ...
  function IncidentDamages() {
    ...
    _defineProperty(_assertThisInitialized(_this), "printCart", function (row) {
      var loadDataPrint = _this.props.loadDataPrint;
      var page = {
        id: row.id,
        isPrint: 1
      };
  ...
  _createClass(IncidentDamages, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.props.printer === true && prevProps.modalType === this.props.modalType && this.props.printer !== prevProps.printer) {
        ...
        react_dom_test_utils__WEBPACK_IMPORTED_MODULE_15___default.a.Simulate.click(node);
      }

      if (this.props.printerAll === true && this.props.printerAll !== prevProps.printerAll) {
        var _node = document.querySelector('.btPrintAll');

        react_dom_test_utils__WEBPACK_IMPORTED_MODULE_15___default.a.Simulate.click(_node);
      }
    } //load datatable
      ...
      columns = [{
        ...
        render: function render(text, row) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_common_control_style__WEBPACK_IMPORTED_MODULE_4__["StatusTag"], {
            style: {
              backgroundColor: row.payTypeOfType === 1 ? '#3498db' : '#f1c40f'
            }
        ...
        render: function render(text, row) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_common_control_style__WEBPACK_IMPORTED_MODULE_4__["ActionWrapper"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_8__["Tooltip"], {
            ...
            onClick: _this3.handleSubmit.bind(_this3, 'confirm', row),
            style: {
            ...
            type: "check"
          }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_to_print__WEBPACK_IMPORTED_MODULE_16___default.a, {
            key: "print",
            ...
            content: function content() {
              return _this3.componentPrintRef;
            },
            onAfterPrint: function onAfterPrint() {
              return _this3.updatePrinter(row, false);
            }
          }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
            onClick: function onClick() {
              return _this3.printCart(row);
            },
            style: {
              backgroundColor: '#f1c40f'
            },
          ...
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_print__WEBPACK_IMPORTED_MODULE_17__["default"], {
            row: rowCart,
            ref: function ref(el) {
              return _this3.componentPrintRef = el;
            }
          })));
        }
      }];
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(function (state) {
  return _objectSpread({}, state.CartWaitReducer);
}, _objectSpread({}, _redux_CartWait_actions__WEBPACK_IMPORTED_MODULE_11__["default"]))(IncidentDamages));

/***/ }),

/***/ "./resources/js/isomophic/admin/containers/CartWait/print.js":
/*!*******************************************************************!*\
  !*** ./resources/js/isomophic/admin/containers/CartWait/print.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
var ComponentToPrint = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ComponentToPrint, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Title, {
        level: 3,
        style: {
          marginTop: 50,
          marginBottom: 10
        }
      }, "NATURIX FARMFOOD"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Icon"], {
        style: {
          fontSize: 20,
          marginRight: 6
        },
      ...
      }, "Nam B\xF9i"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Icon"], {
        type: "phone",
        style: {
          fontSize: 20,
          marginRight: 6
      ...
      }, "035.581.7589"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"], {
        column: 1
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"].Item, {
        style: {
          fontSize: 20
        },
        label: "Ng\u01B0\u1EDDi nh\u1EADn"
      }, row ? row.name : ''), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"].Item, {
        style: {
          fontSize: 20
        },
        label: "S\u1ED1 \u0111i\u1EC7n tho\u1EA1i"
      }, row ? row.phone : ''), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"].Item, {
        style: {
          fontSize: 20
        },
        label: "\u0110\u1ECBa ch\u1EC9"
      }, row ? row.address : '')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"], {
        column: 2
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"].Item, {
        style: {
          fontSize: 20
        ...
        label: "Ti\u1EC1n ship"
      }, row ? row.payTypeOfType === 2 ? '15,000 ₫' : '35,000 ₫' : ''), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"].Item, {
        style: {
          fontSize: 20
        },
      ...
      }, row ? convertNumber(row.totalmoney) + ' ₫' : '')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_5__["Descriptions"].Item, {
        style: {
          fontSize: 20
        },
        label: "Ti\u1EC1n h\xE0ng"
      }, row ? row.payTypeOfType === 2 ? convertNumber(row.totalmoney - 15000) + ' ₫' : convertNumber(row.totalmoney - 35000) + ' ₫' : '')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Text, {
        style: {
          fontSize: 25,
          fontWeight: 700,
          fontStyle: 'italic'
        }
      }, "Naturix farmfood xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n"));
    }
  }]);
