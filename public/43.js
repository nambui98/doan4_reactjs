...
/***/ "./resources/js/isomophic/admin/components/PromotionType/index.js":
/*!************************************************************************!*\
  !*** ./resources/js/isomophic/admin/components/PromotionType/index.js ***!
  \************************************************************************/
  ...
  _createClass(ModalFormAccount, [{
    ...
    value: function render() {
        ...
        _this2.props.form.validateFieldsAndScroll(function (err, values) {
          if (!err) {
            if (modalType === 'changeStatus') {
              ...
              row.numbersale = values.numbersale; // row.status = modalType === 'insert' ? 1 : values.status;
            }
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Modal, {
        ...
        label: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Ki\u1EC3u gi\xE1 tr\u1ECB"),
        hasFeedback: true,
        style: {
          marginBottom: 10 + 'px'
        }
        ...
        value: 1
      }, "Ph\u1EA7n tr\u0103m"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Option, {
        value: 2
      }, "Ti\u1EC1n")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FormItem, _extends({}, _helpers_formItem__WEBPACK_IMPORTED_MODULE_10__["default"], {
        label: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Gi\xE1 tr\u1ECB"),
        hasFeedback: true,
        style: {
          marginBottom: 10 + 'px'
        }
...
/***/ "./resources/js/isomophic/admin/containers/PromotionType/index.js":
/*!************************************************************************!*\
  !*** ./resources/js/isomophic/admin/containers/PromotionType/index.js ***!
  \************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _components_PromotionType__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../components/PromotionType */ "./resources/js/isomophic/admin/components/PromotionType/index.js");
/* harmony import */ var _redux_PromotionType_actions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../redux/PromotionType/actions */ "./resources/js/isomophic/admin/redux/PromotionType/actions.js");
    ...
    value: function render() {
      ...
      columns = [{
        ...
        render: function render(text, row) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, row.type === 1 ? 'Phầm trăm' : 'Số tiền');
        }
      }, {
        ...
        className: 'noWrapCell',
        sorter: function sorter(a, b) {
          if (a.numbersale < b.numbersale) return -1;
          if (a.numbersale > b.numbersale) return 1;
          return 0;
        },
        render: function render(text, row) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, row.type === 1 ? row.numbersale + ' %' : convertNumber(row.numbersale) + ' ₫');
        }
      }, // {
      // 	title: 'Nhân viên',
      // 	dataIndex: 'loai',
      ...
      }), row ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_PromotionType__WEBPACK_IMPORTED_MODULE_10__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(function (state) {
  return _objectSpread({}, state.PromotionTypeReducer);
}, _objectSpread({}, _redux_PromotionType_actions__WEBPACK_IMPORTED_MODULE_11__["default"]))(IncidentDamages));
