...
export default function userReducer(state = initState, { type, payload, ...action }) {
	switch (type) {
		...
		case actions.LOAD_DATA_PRINT_SUCCESS:
			console.log(payload.data.isPrint);
			debugger;
			return {
				...state,
				isLoading: false,
				rowCart: payload.data.data,
				errorMessage: false,
				printer: false,
