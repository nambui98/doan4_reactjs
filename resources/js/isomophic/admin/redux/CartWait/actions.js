...
const actions = {
	...
	LOAD_DATA_PRINT: DOCUMENT + 'LOAD_DATA_PRINT',
	LOAD_DATA_PRINT_SUCCESS: DOCUMENT + 'LOAD_DATA_PRINT_SUCCESS',
	loadData: (data) => {
	...
	loadDataPrint: (data) => ({
		type: actions.LOAD_DATA_PRINT,
		payload: data
	}),
	loadDataPrintSuccess: (data) => ({
		type: actions.LOAD_DATA_PRINT_SUCCESS,
		payload: { data }
	})
};
