...
import { Row, Col, Icon, Input, Popconfirm, Tooltip } from 'antd';
import Box from '../../../components/utility/box';
import Modal from '../../components/CategoriesTwo';
import actions from '../../redux/CartDelivery/actions';
	...
	render() {
		...
		columns = [
			...
			},
			{
				...
				render: (text, row) => {
					return <StatusTag style={{ backgroundColor: '#f1c40f' }}>Đang giao</StatusTag>;
				}
			},
			...
			<DataWrapper>
				<LayoutWrapper style={{ padding: '0px' }}>
					<h1 className="PageHeader">
						{' '}
						<IntlMessages id="sidebar.cartDelivery" />
					</h1>
