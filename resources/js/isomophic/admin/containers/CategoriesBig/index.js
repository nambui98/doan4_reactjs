...
import Modal from '../../components/CategoriesBig';
import actions from '../../redux/CategoriesBig/actions';
			...
			<DataWrapper>
				<LayoutWrapper style={{ padding: '0px' }}>
					<h1 className="PageHeader">
						{' '}
						<IntlMessages id="sidebar.categoriesBig" />
					</h1>
