...
import actions from '../../redux/CartCancel/actions';
	...
	render() {
		...
		columns = [
			...
			},
			{
				...
				render: (text, row) => {
					return <StatusTag style={{ backgroundColor: '#e74c3c' }}>Đã huỷ</StatusTag>;
				}
			},
			{
				title: 'Ngày cập nhật',
			...
			<DataWrapper>
				<LayoutWrapper style={{ padding: '0px' }}>
					<h1 className="PageHeader">
						{' '}
						<IntlMessages id="sidebar.cartCancel" />
					</h1>
