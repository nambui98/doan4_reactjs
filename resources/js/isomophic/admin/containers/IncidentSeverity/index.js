...
import Modal from "../../components/IncidentSeverity";
import actions from "../../redux/IncidentSeverity/actions";
...
class Users extends BaseComponent {
  componentDidMount() {
    ...
    listenSocket(this.socketIO, flags.INCIDENT_SEVERITY, (flag, data) => {
      const newPage = {
        name: this.state.search,
        page: this.state.page,
        limit: dataConfig.pageLimit
      ...
      <DataWrapper>
        <LayoutWrapper style={{ padding: "0px" }}>
          <h1 className="PageHeader">
            {" "}
            <IntlMessages id="sidebar.incident_severity" />
          </h1>
